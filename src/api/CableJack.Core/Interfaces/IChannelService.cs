...
namespace CableJack.Core.Interfaces
{
    ...
    {
        Task<PagedResult<ChannelResponse>> GetChannelsAsync(PaginationParams pagination, int? categoryId = null, bool includeInactive = false, string? search = null, int? providerId = null);
